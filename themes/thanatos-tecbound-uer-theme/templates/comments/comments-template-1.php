			...
			case 'trackback' :
				...
				<li class="post pingback">
					...
					<article id="li-comment-<?php comment_ID() ?>" class="comment-body">
						<p><?php esc_html_e( 'Pingback:', 'goza' ); ?> <?php comment_author_link(); ?><?php edit_comment_link( esc_html__( 'Edit', 'goza' ), '<span class="edit-link">', '</span>' ); ?></p>
				...
				<article id="li-comment-<?php comment_ID() ?>" class="comment-body">
					...
					--><div class="comment-aside">
						...
						<?php if ( $comment->comment_approved == '0' ) : ?>
							<em class="comment-awaiting-moderation"><?php esc_html_e( 'Your comment is awaiting moderation.', 'goza' ); ?></em>
							<br/>
						<?php endif; ?>
					</div><!-- /.comment-aside -->
