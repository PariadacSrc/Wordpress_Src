...
<article id="post-<?php the_ID(); ?>" <?php post_class( implode(' ', $article_classes) ); ?> itemscope="itemscope" itemtype="http://schema.org/BlogPosting" itemprop="blogPost">
	<div class="post-inner">
		<!-- Post quote -->
		<?php if(!empty($goza_post_options['quote'])) { ?>
			<div class="post-block-quote-wrap" style="background: url(<?php echo esc_attr($goza_post_thumbnail_url); ?>) no-repeat center center / cover;">
				<i class="fa fa-quote-left"></i>
				<?php echo "{$goza_post_options['quote']}"; ?>
			</div>
		<?php } ?>
