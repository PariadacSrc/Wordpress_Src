...
if($prev_post) {
   ...
   echo implode('', array(
     '<a class="prev-link" rel="prev" href="'. get_permalink($prev_post->ID) .'" title="'. $prev_title .'">',
      '<div class="btn-text"><span class="ion-ios-arrow-left"></span>' . __('Previous post', 'goza') . '</div>',
...
if($next_post) {
   ...
   echo implode('', array(
     '<a class="next-link" rel="prev" href="'. get_permalink($next_post->ID) .'" title="'. $next_title .'">',
      '<div class="btn-text">' . __('Next post', 'goza') . '<span class="ion-ios-arrow-right"></span></div>',
