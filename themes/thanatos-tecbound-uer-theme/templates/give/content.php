...
if ( has_post_thumbnail() ) {
  $thumbnail_html = get_the_post_thumbnail( get_the_ID(), 'goza-image-medium', array( 'class' => 'give-thumbnail' ) );
}
...
<article id="post-recipe-<?php the_ID(); ?>" <?php post_class( implode(' ', $article_classes) ); ?> itemscope="itemscope" itemtype="http://schema.org/GivePosting" itemprop="GivePost">
    ...
    <div class="post-entry-wrap">
      ...
      <a class="readmore" href="<?php the_permalink(); ?>"><?php _e('Read More', 'goza'); ?> <span class="ion-ios-arrow-thin-right"></span></a>
    </div>
	</div>
</article>
