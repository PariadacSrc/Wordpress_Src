...
<div class="post-item-container-wrap">
  <?php echo (isset($goza_post_options['video']) && ! empty($goza_post_options['video'])) ? '<div class="post-layout-creative-video-wrap" data-stellar-ratio=".8">' . $goza_post_options['video'] . '</div>' : ''; ?>
